...
:root {
  ...
  --color-accent-primary-a10: rgba(204, 255, 0, 0.10);
  --color-accent-primary-a15: rgba(204, 255, 0, 0.15);
  --color-accent-primary-a20: rgba(204, 255, 0, 0.20);
  --color-accent-primary-a30: rgba(204, 255, 0, 0.30);
  --color-accent-primary-a80: rgba(204, 255, 0, 0.80);
  ...
  --color-overlay-black-a20: rgba(10, 10, 10, 0.20);
  --color-overlay-black-a30: rgba(0, 0, 0, 0.30);
  --color-overlay-black-a60: rgba(0, 0, 0, 0.60);
  --color-overlay-white-a00: rgba(255, 255, 255, 0.00);
  --color-overlay-white-a05: rgba(255, 255, 255, 0.05);
  --color-overlay-white-a10: rgba(255, 255, 255, 0.10);
  --color-overlay-white-a80: rgba(255, 255, 255, 0.80);
